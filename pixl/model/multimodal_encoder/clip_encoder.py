...
from pixl.model.language_model.configuration_pixl import PIXLVisionConfig


class CLIPVisionTower(CLIPPreTrainedModel):
    config_class = PIXLVisionConfig
...
if __name__ == '__main__':
    ...
    print("################ clip_config ##############")
    print(clip_config)
    phi_vis_config = PIXLVisionConfig(**clip_config.to_dict())
