...
class PIXLVisionConfig(PretrainedConfig):
    r"""
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Union[str, os.PathLike], **kwargs) -> "PretrainedConfig":
        ...
        if (config_dict.get("model_type") == "pixl_phi" or config_dict.get("model_type") == "pixl_gemma"
                or config_dict.get("model_type") == "pixl_phi3"):
...
DEFAULT_VISUAL_CONFIG = {
    "vision_tower": PIXLVisionConfig().to_dict(),
    "mm_projector": ProjectorConfig().to_dict()
}


class PIXLPhiConfig(PhiConfig):
    model_type = "pixl_phi"
...
class PIXLPhi15Config(Phi1_5Config):
    model_type = "pixl_phi"
...
class PIXLGemmaConfig(GemmaConfig):
    model_type = "pixl_gemma"
...
class PIXLPhi3Config(Phi3Config):
    model_type = "pixl_phi3"
