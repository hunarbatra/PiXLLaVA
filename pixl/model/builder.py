...
from pixl.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="cuda",
    ...
    if "phi3" in model_name.lower() or "phi-3" in model_name.lower():
        print("load PIXL-Phi3 MSLM!!!")
        config = PIXLPhi3Config.from_pretrained(model_path, trust_remote_code=True)
        ...
        config = PIXLPhiConfig.from_pretrained(model_path, trust_remote_code=True)
        ...
        config = PIXLPhi15Config.from_pretrained(model_path, trust_remote_code=True)
        ...
        config = PIXLGemmaConfig.from_pretrained(model_path, trust_remote_code=True)
