...
from pixl.eval.mmmu_data_utils import CAT_SHORT2LONG, DOMAIN_CAT2SUB_CAT
from pixl.eval.mmmu_eval_utils import evaluate, parse_open_response, calculate_ins_level_acc
