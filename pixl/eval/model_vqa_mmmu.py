...
from pixl.eval.mmmu_data_utils import load_yaml, construct_prompt, save_json, process_single_sample, CAT_SHORT2LONG
from pixl.eval.mmmu_eval_utils import parse_multi_choice_response




def call_pixl_engine_df(args, sample, model, tokenizer=None, processor=None, conv_mode="phi"):
...
def main(args):
    ...
    call_model_engine = call_pixl_engine_df
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output-path', type=str, default='pixl_3b_val.json',
                        help='name of saved json')
    parser.add_argument('--config-path', type=str, default="pixl/eval/pixl.yaml")
