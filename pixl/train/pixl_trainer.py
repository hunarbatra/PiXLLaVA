...
# class PIXLTrainer(Trainer): # old pixl-trainer
...
#         super(PIXLTrainer, self)._save_checkpoint(model, trial, metrics)

#     def _save(self, output_dir: Optional[str] = None, state_dict=None):
#         super(PIXLTrainer, self)._save(output_dir, state_dict)