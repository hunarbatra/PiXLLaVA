...
## llama-3.1-8b
model_name=PiXLLaVALlama2-v2-7b-pretrain
model_dir=./ckpts/checkpoints-siglip/base_checkpoints/pixllava_llama2_7b
outputdir=./ckpts/checkpoints-siglip/llama2_7b/$model_name
