...
## llama-3.2-3b
model_name=PiXLLaVAVicuna-v2-7b-pretrain
model_dir=./ckpts/checkpoints-siglip/base_checkpoints/pixllava_vicuna_7b
outputdir=./ckpts/checkpoints-siglip/vicuna_7b/$model_name
